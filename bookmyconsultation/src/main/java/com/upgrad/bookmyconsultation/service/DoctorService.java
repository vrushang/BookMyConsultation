...
public class DoctorService {
    ...
    public Doctor register(Doctor doctor) throws InvalidInputException{
        ...
        newAddress.setId(doctor.getAddress().getId());
        newAddress.setAddressLine1(doctor.getAddress().getAddressLine1());
        newAddress.setAddressLine2(doctor.getAddress().getAddressLine2());
        newAddress.setCity(doctor.getAddress().getCity());
        newAddress.setPostcode(doctor.getAddress().getPostcode());
        newAddress.setState(doctor.getAddress().getState());
    ...
    public Doctor getDoctor(String id){
        ...
        return Optional.ofNullable(findDoctor).orElseThrow(ResourceUnAvailableException::new);
    }
